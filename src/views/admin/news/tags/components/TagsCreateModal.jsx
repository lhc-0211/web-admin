...
import { apiCreateNewsTagsAdmin } from '@/services/NewsService'
...
// Schema validation cho form tạo tag
...
const TagsCreateModal = ({ isOpen, onClose }) => {
    ...
    const onSubmit = async (data) => {
        try {
            ...
            await apiCreateNewsTagsAdmin(body)

            mutate() // Refresh danh sách tag
            onClose()
            reset()

            toast.push(
                <Notification title="Thành công" type="success">
                    Tạo tag <strong>{data.name}</strong> thành công!
                </Notification>,
            )
        } catch (error) {
