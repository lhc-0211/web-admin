...
import { apiCreateSchedulesAdmin } from '@/services/ScheduleService'
...
// Schema validation cho form tạo lịch công tác
...
const SchedulesCreateModal = ({ isOpen, onClose }) => {
    ...
    const { scheduleTypes } = useAllSchedulesTypes() // Lấy danh sách loại lịch để chọn
    ...
    const onSubmit = async (data) => {
        try {
            const body = {
                ...
                participantIds: [], // Có thể mở rộng sau
                ...
                attachmentFileIds: [], // Có thể mở rộng sau
            }

            await apiCreateSchedulesAdmin(body)
