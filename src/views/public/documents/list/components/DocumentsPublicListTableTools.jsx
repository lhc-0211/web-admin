...
import useAllFields from '@/views/admin/documents/fields/hooks/useAllFields'
import useAllTypes from '@/views/admin/documents/type/hooks/useAllTypes'
...
export default function DocumentsPublicListTableTools() {
    ...
    const { control, handleSubmit, reset, watch, setVale } = useForm({
        defaultValues: {
    ...
    return (
        <>
            ...
            {/* Drawer bộ lọc */}
            <Drawer
                title="Bộ lọc Văn bản công khai"
                isOpen={filterIsOpen}
